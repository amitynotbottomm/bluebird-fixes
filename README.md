...
Use the provided '2mount.sh' and '2umount.sh' bash scripts.
...
Running the 'battery.sh' script will print the current charge and charge status of the battery.
The path to the battery class may be different on other machines.
